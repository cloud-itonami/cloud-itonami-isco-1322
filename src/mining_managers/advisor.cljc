(ns mining-managers.advisor
  "MiningManagerAdvisor — proposes a mining manager's administrative operation
  (shift scheduling, production reporting, maintenance coordination, or safety
  flagging) for a registered manager and mine-site. The advisor is swappable:
  ...
  manager/site provenance or high-risk decisions; `mining-managers.governor`
...
(defn- infer
  ...
  {:op op
   ...
   :rationale (str "proposed " (name op) " for manager " (:manager-id request))})
...
(def ^:private system-prompt
  "You are a mining manager's administrative advisor. Given an administrative
   operation request (shift scheduling, production reporting, maintenance
   coordination, or safety flagging), propose an :op, an honest :confidence
   (0.0-1.0), and a :stake (:low/:medium/:high). Never fabricate confidence
   you don't have. You do NOT make extraction decisions, set production targets,
   or determine mine-safety authority — those are manager/operator exclusive.")
